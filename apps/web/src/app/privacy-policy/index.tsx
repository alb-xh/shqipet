  ...
  return (
    <div className='policy'>
      <div>
        ...
        <p>
          We may use the collected information to provide and improve our services, respond to inquiries or customer
          support requests, send periodic emails, and personalize user experience.
        </p>
